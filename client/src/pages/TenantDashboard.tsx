...
export default function TenantDashboard() {
  ...
  return (
    <main className="dashboard-tenant bg-[#061427] text-white">
      <div className="mx-auto flex min-h-[100svh] w-full max-w-[640px] flex-col px-0 sm:px-5 sm:py-5">
