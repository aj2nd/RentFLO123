    ...
    <div className="min-h-screen bg-black text-zinc-300 selection:bg-[#C0C0C0] selection:text-black">
      ...
      <main className="pt-32 pb-20 px-6 md:px-12 max-w-8xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[90vh]">
        <div className="space-y-8">
          ...
          <p className="text-xl md:text-2xl text-zinc-500 font-light max-w-md border-l border-[#6FFFE9]/20 pl-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-8">
            ...
            <button
              ...
              className="inline-flex items-center justify-center h-14 px-8 border border-[#6FFFE9]/20 text-zinc-400 hover:text-zinc-100 hover:border-[#6FFFE9]/50 transition-all font-medium rounded-none"
        ...
        <div className="relative hidden lg:block h-[600px] w-full bg-zinc-950 border border-white/5 p-8 overflow-hidden group">
          <div className="absolute inset-0 bg-gradient-to-tr from-black via-zinc-950 to-zinc-900 opacity-80" />
          <div className="relative z-10 space-y-6">
            <div className="w-full h-40 border border-white/5 bg-black/50 backdrop-blur-md p-6 flex flex-col justify-between group-hover:translate-y-[-5px] transition-transform duration-500">
              ...
              <div className="space-y-2">
                ...
                <div className="h-3 w-32 bg-zinc-700"></div>
              </div>
            </div>
            <div className="w-full h-40 border border-white/5 bg-black/50 backdrop-blur-md p-6 flex flex-col justify-between group-hover:translate-y-[-5px] transition-transform duration-500 delay-100">
              <div className="flex justify-between">
                <div className="h-2 w-20 bg-zinc-700"></div>
                <div className="h-2 w-2 bg-zinc-600"></div>
              </div>
              <div className="space-y-2">
                <div className="h-10 w-32 bg-zinc-800"></div>
                <div className="h-3 w-24 bg-zinc-700"></div>
              </div>
            </div>
      ...
      {/* Features */}
      <section id="features-section" className="py-24 px-6 md:px-12 border-t border-white/5">
      ...
      <footer className="py-12 px-6 md:px-12 border-t border-white/5 text-center text-zinc-600 text-sm">
  ...
  return (
    <div className="flex items-start gap-5">
      <div className="flex-shrink-0 mt-1">
        <CheckCircle2 className="w-7 h-7 text-zinc-300" strokeWidth={2.5} />
      </div>
      <div>
