    ...
    <main className="dashboard-owner bg-[#020812] text-white">
      <div className="mx-auto w-full max-w-[640px] px-0 sm:px-5 sm:py-5">
        <section className="relative aspect-[822/1735] w-full overflow-hidden sm:rounded-[30px] sm:shadow-[0_28px_80px_rgba(0,0,0,0.55)]" aria-label="RentFLO owner dashboard">
          ...
          <OwnerConnectionZone label="Owner home" className="left-[5.2%] top-[82.5%] h-[7.4%] w-[15.5%]"><Link href="/owner" className="block h-full w-full rounded-xl focus-visible:ring-2 focus-visible:ring-violet-300" aria-label="Owner home" /></OwnerConnectionZone>
          <OwnerConnectionZone label="Open owner ledger" className="left-[21.8%] top-[82.5%] h-[7.4%] w-[15.5%]"><Link href="/ledger" className="block h-full w-full rounded-xl focus-visible:ring-2 focus-visible:ring-violet-300" aria-label="Open owner ledger" /></OwnerConnectionZone>
          <OwnerConnectionZone label="Open repairs" className="left-[38.2%] top-[82.5%] h-[7.4%] w-[15.5%]"><Link href="/maintenance" className="block h-full w-full rounded-xl focus-visible:ring-2 focus-visible:ring-violet-300" aria-label="Open repairs" /></OwnerConnectionZone>
          <OwnerConnectionZone label="Open owner messages" className="left-[54.7%] top-[82.5%] h-[7.4%] w-[15.5%]"><Link href="/messages" className="block h-full w-full rounded-xl focus-visible:ring-2 focus-visible:ring-violet-300" aria-label="Open owner messages" /></OwnerConnectionZone>
          <OwnerConnectionZone label="Open owner profile" className="left-[71.2%] top-[82.5%] h-[7.4%] w-[15.5%]"><Link href="/profile" className="block h-full w-full rounded-xl focus-visible:ring-2 focus-visible:ring-violet-300" aria-label="Open owner profile" /></OwnerConnectionZone>
