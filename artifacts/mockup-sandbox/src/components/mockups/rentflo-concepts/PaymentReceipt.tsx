  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        @keyframes glowPulse { 0%,100%{box-shadow:0 0 40px rgba(111,255,233,0.15)} 50%{box-shadow:0 0 80px rgba(111,255,233,0.35)} }
        ...
        @keyframes flipHint { 0%{transform:rotateY(0deg)} 15%{transform:rotateY(8deg)} 30%{transform:rotateY(0deg)} 100%{transform:rotateY(0deg)} }
      `}</style>
      ...
      <div
        onClick={toggle}
        style={{ perspective: '1100px', perspectiveOrigin: '50% 50%', cursor: 'pointer', position: 'relative', zIndex: 5 }}
      >
        {/* Bloom */}
        <div style={{
          position: 'absolute', inset: '-30px', borderRadius: 0,
          background: flipped
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              padding: '4px 12px', fontSize: 8, letterSpacing: '0.2em', fontWeight: 700, color: '#facc15',
            ...
            {/* Decorative corner */}
            <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: 3, background: 'linear-gradient(90deg, transparent, rgba(250,204,21,0.15), transparent)' }} />
          </div>
          ...
          <div style={{
            ...
            {/* Top accent */}
            <div style={{ height: 3, background: `linear-gradient(90deg, transparent, ${T}, transparent)`, boxShadow: `0 0 8px ${T}` }} />
            ...
            {/* Bottom accent */}
            <div style={{ height: 3, background: `linear-gradient(90deg, transparent, rgba(${TRGB},0.15), transparent)` }} />
          </div>
        </div>
      </div>
